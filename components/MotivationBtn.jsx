...
export default function MotivationBtn() {
    ...
    return (
        <TouchableOpacity style={{ width: "85%", borderRadius: "15px", height: "10%", marginBottom: "10%", backgroundColor: "#FFF", justifyContent: 'center', marginTop: "27%" }} onPress={() => setBtnData(data[Math.floor(Math.random() * data.length)])}>
